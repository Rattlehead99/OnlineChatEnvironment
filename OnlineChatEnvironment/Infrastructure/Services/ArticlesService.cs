...
namespace OnlineChatEnvironment.Services
{
    ...
    using static OnlineChatEnvironment.Data.DataConstants.Role;
    ...
    public class ArticlesService : IArticlesService
    {
        ...
        public ArticlesService(ApplicationDbContext db, UserManager<User> userManager, IHttpContextAccessor httpContextAccessor, IPaginationService paginationService)
        {
            this.db = db;
